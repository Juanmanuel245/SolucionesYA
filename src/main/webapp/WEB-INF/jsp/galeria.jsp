	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<!--TITULO-->
			   <div class="panel-heading text-center"><h2 class="panel-title">Subir foto de trabajos realizados</h2></div>
			...
			<div class="panel panel-default">
			<!--SECTOR DE IMAGENES-->
			   <div class="panel-heading text-center"><h2 class="panel-title">Imagenes archivadas</h2></div>
				<div class="panel-body">
					<div class="row">
					  <div class="col-md-3">
