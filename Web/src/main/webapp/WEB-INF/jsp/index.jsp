			...
			<div class="col-sm-12 paddingMenuPrincipal">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-lg-3 col-md-4 col-xs-6 thumb">
							<a class="thumbnail" href="publicacion?id=1"><img
					...
					<div class="panel-body">
						...
						<div class="col-sm-12">
							...
							<div class="col-lg-2 col-md-3 col-xs-3">
								<p>
									<b>1-PUBLICA:</b><br>
									<small>Publicá en SolucionesYa, registrate y hace una
										publicacion en pocos minutos. Es rapido y facil!</small>
								</p>
							</div>
							<div class="col-lg-2 col-md-3 col-xs-3">
								<p>
									<b>2-TE CONTACTAN:</b><br>
									<small>Dejá tu número de teléfono o email en el aviso
										para que te puedan contactar fácil y rápidamente los
										interesados.</small>
								</p>
							</div>
							<div class="col-lg-2 col-md-3 col-xs-3">
								<p>
									<b>3-SE ENCUENTRAN:</b><br>
									<small>Coordinan con el interesado de tu zona para
										realizar los trabajos pactados, nunca fue mas rapido y facil.</small>
								</p>
							</div>
							<div class="col-lg-3 col-md-3 col-xs-3"></div>
						</div>
